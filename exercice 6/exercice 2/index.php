...
if(isset($_POST['envoie'])){
    try{
        if (empty($_POST['card'])==false){
            ...
            $sql="INSERT INTO clients (lastName, firstName,birthDate,card,cardNumber ) VALUES (:nom,:prenom,:naissance,:card,:cardN);INSERT INTO cards (cardNumber, cardTypesID ) VALUES (:cardN,:cardT);";
            include('./php-pdo/connect.php');
            $requete->bindParam(":card", $_POST['card']);
            $requete->bindParam(":cardN", $_POST['cardNulber']);
            $requete->bindParam(":cardT", $_POST['cardType']);
        }else{
...
<body>
    <form action="#" method="post">
        ...
        <input type="number" name="cardNulber" id="cardNulber"><br>
        <label for="cardType">Type de card</label>
